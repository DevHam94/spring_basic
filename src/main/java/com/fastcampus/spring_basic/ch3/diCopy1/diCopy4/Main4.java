package com.fastcampus.spring_basic.ch3.diCopy1.diCopy4;
...
class AppContext {
    ...
    private void doComponentScan() {
        try {
            ...
            // 2. 반복문으로 클래스를 하나씩 읽어와서 @Component
            // 3. @Component가 붙어있으면 객체를 생성해서 map에 저장
            ClassLoader classLoader = AppContext.class.getClassLoader();
            ClassPath classPath = ClassPath.from(classLoader);

            Set<ClassPath.ClassInfo> set = classPath.getTopLevelClasses("com.fastcampus.spring_basic.ch3.diCopy4");
